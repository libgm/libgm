...
typedef experimental::canonical_gaussian<vec> cgaussian;
...
BOOST_AUTO_TEST_CASE(test_multiplication) {
  ...
  mgaussian h2 = g * f;
  param_type p2 = h.param().reorder({1, 2, 0}, {});
