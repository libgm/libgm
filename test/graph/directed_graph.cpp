...
namespace libgm {
  template class directed_graph<std::size_t>;
  template class directed_graph<std::size_t, std::string, double>;
}

using namespace libgm;

typedef directed_graph<std::size_t, std::size_t, std::size_t> graph_type;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_comparison, EP, test_types) {
  typedef directed_graph<std::size_t, int, EP> Graph;
