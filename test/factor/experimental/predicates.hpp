#ifndef LIBGM_TEST_FACTOR_EXPERIMENTAL_PREDICATES_HPP
#define LIBGM_TEST_FACTOR_EXPERIMENTAL_PREDICATES_HPP
...
boost::test_tools::predicate_result
cg_params(const F& f,
          const libgm::real_vector<>& eta,
          const libgm::real_matrix<>& lambda,
          double lm) {
...
boost::test_tools::predicate_result
mg_params(const F& f,
          const libgm::real_vector<>& mean,
          const libgm::real_matrix<>& cov,
          const libgm::real_matrix<>& coef,
          double lm) {
