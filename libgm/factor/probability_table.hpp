...
#include <libgm/factor/expression/table_restrict.hpp>
#include <libgm/factor/expression/table_selector.hpp>
#include <libgm/factor/expression/table_transform.hpp>
...
namespace libgm {
  ...
  public:
    ...
    using factor_type = probability_table<RealType>;

    // ParametricFactorExpression types
    using param_type = table<RealType>;
    using shape_type = uint_vector;
    using distribution_type = multivariate_categorical_distribution<RealType>;
  ...
  public:
    ...
    using ll_type  = probability_table_ll<RealType>;
    using mle_type = probability_table_mle<RealType>;
    ...
    static uint_vector shape(const domain<Arg>& dom) {
