#ifndef LIBGM_SoftmaxLL_HPP
#define LIBGM_SoftmaxLL_HPP

#include <libgm/datastructure/real_pair.hpp>
#include <libgm/functional/arithmetic.hpp>
#include <libgm/math/param/Softmax.hpp>
 ...
 * argument of type Label, which can be either a size_t or an
...
public:
   ...
   */
  explicit SoftmaxLL(const Softmax<T>& f)
    : f(f) { }
